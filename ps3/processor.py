...
class Ps3IsoProcessor(BaseIsoProcessor):
    SFO_HEADER_BYTES = 20
    ...
    def get_file_hashes(self):
        # NOTE: Contents of USRDIR including the EBOOT.BIN will be encrypted. Script currently doesn't support decryption.
        file_hashes = {}
        ...
        for file in self.iso_path_reader.iso_iterator(root, recursive=True):
            ...
            if file_path.startswith("/PS3_UPDATE/"):
                continue
    ...
    def get_most_recent_file(self):
        ...
        root = self.iso_path_reader.get_root_dir()
        for file in self.iso_path_reader.iso_iterator(root, recursive=True):
            if self.iso_path_reader.get_file_path(file).startswith("/PS3_UPDATE/"):
                continue
    ...
    def get_extra_fields(self):
        param_sfo = self.iso_path_reader.get_file("/PS3_GAME/PARAM.SFO")
