...
class PKGMetaData:
    ...
    unk_0x9: int = 0
    unk_0xB: int = 0
    package_revision: PackageRevision = PackageRevision()
    software_revision: SoftwareRevision = SoftwareRevision()
    title_id: bytes = b""
    install_dir: bytes = b""
    item_info: VitaItemInfo = VitaItemInfo()
    sfo_info: VitaSfoInfo = VitaSfoInfo()
    unknown_data_info: VitaUnknownDataInfo = VitaUnknownDataInfo()
    entirety_info: VitaEntiretyInfo = VitaEntiretyInfo()
    version_info: VitaVersionInfo = VitaVersionInfo()
    self_info: VitaSelfInfo = VitaSelfInfo()
