...
class CD32IsoProcessor(BaseIsoProcessor):
    ...
    def get_exe_filename(self):
        # Note: This isn't the actual executable. The executable itself needs to be interpreted from the
        # Startup-Sequence file. It'll most likely be the last file referenced from the bottom.
        for dir in ["/S", "/s"]:
            try:
